...
using GetPleasanterSite.CallableCommand;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        //args = new string[] { "GetSite", "out.xml" };
        //args = new string[] {  };

        logger.Info($"Pleasanter サイト設定取得 コマンド　起動!!! ");
        ...
        rootCommand.Description = "Pleasanter サイト設定取得";

        // 取得コマンドを追加
        rootCommand.Add(OnGetSite.MakeCommand());
        ...
        logger.Info($"Pleasanter サイト設定取得 コマンド　終了!!! ");
